...
// const myTopics = ['javascript', 'bootstrap', 'technology', 'jquery', 'node.js']
...
const tabsAppender = (selector) => {
  // TASK 4
  // ---------------------
  // Implement this function which takes a css selector as its only argument. X
  ...
  .then(resp => {
    ...
    const newTabs = Tabs(topicsArray);
